            ...
            auctions.forEach((auction) => {
              telegram
                ...
                .then((res) => {
                  ...
                  const filePath = "C://agreement.pdf";
                  telegram.sendDocument(auction.bestBidder.chatId, filePath);
                  telegram.sendDocument(auction.owner.chatId, filePath);
                });

              managerFactory.getAuctionManager().updateAuction(auction._id, {
                state: consts.AUCTION_STATE_PAYMENT_REQ_SENT,
              });
            });
